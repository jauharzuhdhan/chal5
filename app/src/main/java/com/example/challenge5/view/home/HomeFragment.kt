package com.example.challenge5.view.home
...
import com.example.challenge5.service.APIService
import com.example.challenge5.view.login.PreferenceKey
...
class HomeFragment : Fragment() {
    ...
    private fun getMovieData(callback: (List<Data>) -> Unit){
        APIService.instance.getPopularMovies().enqueue(object : Callback<MovieResponse> {
